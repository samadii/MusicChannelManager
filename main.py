...
def start(bot, update):
    ...
    reply = "Hi {} ! /nIm MusicChannelManager Bot! /n/nI can add a dynamic caption to the musics, just add me to a channel as admin and give me the permissions.".format(name)
